...
function news_del(obj){
	AjaxPost(obj,"确定要删除吗？此操作不可逆！","<?php echo U('News/delNews');?>");
}
/*资讯-发布*/
function article_start(obj){
	AjaxPost(obj,"确定要还原吗？","<?php echo U('News/restoreNews');?>");
}
/*批量删除方法*/
function datadel(obj)
{
	AjaxPost(obj,"确定要彻底删除吗？此操作不可逆！","<?php echo U('News/delNews');?>");
}
/*清空回收站*/
function datadelAll(obj)
{
	AjaxPost(obj,"确定要清空回收站吗？此操作不可逆！","<?php echo U('News/delNews');?>","bin");
}
</script> 
</body>
</html>