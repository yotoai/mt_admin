...
<div class="pd-20">
  <table class="table table-border table-bordered table-bg table-hover table-sort">
    ...
    <tbody>
      <?php if($logList["flag"] == 'err'): ?><tr class="text-c">
          <td colspan="8"><?php echo ($logList["msg"]); ?></td>
        </tr>
      <?php else: ?>
        <?php if(is_array($logList)): foreach($logList as $key=>$val): ?><tr class="text-c">
          ...
          <td> <a title="删除" href="javascript:;" onclick="log_del(this,<?php echo ($val["id"]); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
